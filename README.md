...
- **Renamed to VoiceInkNeo.** Bundle ID `com.nolaneo.VoiceInkNeo`, display name, all user-visible strings, Application Support path, Keychain service — fully isolated from any upstream VoiceInk install.
