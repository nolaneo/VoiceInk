...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.nolaneo.voiceink", category: "LogExporter")
    private let subsystem = "com.nolaneo.voiceink"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== VoiceInkNeo Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "VoiceInkNeo_Logs_\(timestamp).log"
