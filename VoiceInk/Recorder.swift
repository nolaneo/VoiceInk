...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.nolaneo.voiceink", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.nolaneo.voiceink.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.nolaneo.voiceink.audioSetup", qos: .userInitiated)
